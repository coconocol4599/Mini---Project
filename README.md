...
1️⃣ Enter name 2️⃣ Select account type 3️⃣ Set 4-digit PIN 4️⃣ Enter initial deposit
...
1️⃣ Enter receiver account number 2️⃣ Enter transfer amount 3️⃣ Update both accounts
